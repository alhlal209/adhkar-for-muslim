...
import 'package:flutterap/one.dart';
...
//  String _homeScreenText = "Waiting for token...";
  ...
  void initState() {
    super.initState();
    _firebaseMessaging.subscribeToTopic('ToTopicListen');
            ...
            children: <Widget>[
              ...
              Row(children: <Widget>[
                ...
                FlatButton(
                  ...
                  onPressed:(){
                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => MyAppone()));
                  },
//                  _topicButtonsDisabled
//                      ? null
//                      : () {
//                    _firebaseMessaging
